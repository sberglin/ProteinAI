...
import classifiers.cj48.CC45ModelSelection;
 ...
 */
public class CJ48 extends AbstractClassifier implements OptionHandler, Drawable,
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_binarySplits) {
      ...
      modSelection = new CC45ModelSelection(m_minNumObj, instances,
        m_useMDLcorrection, m_doNotMakeSplitPointActualValue);
    }
    ...
    if (m_binarySplits) {
      ...
      ((CC45ModelSelection) modSelection).cleanup();
    }
  }
